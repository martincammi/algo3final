...
\newpage
\subsection{Gr\'aficos de cantidad de iteraciones de Búsqueda Local}
\begin{center}
...
En el grafico de complejidades se puede observar como las mediciones quedan contenidas por la funci\'on que representa la complejidad te\'orica calculada con respecto al tamaño de la entrada
