...
El parametro $ALFA$ es un valor entre $0$ y $1$ que le dá al algor\'itmo constructivo su nivel de aleatoriedad. Originalmente el algor\'itmo constructivo elije el nodo de mayor grado para orientar, aplicandole $GRASP$ se buscan todos los que tengan $grado > ALFA*GradoMaximo$ y con un valor aleatorio se elije cual se utilizará.\\
