...
//				for(int parametroGRASP: parametroIteracionesGraspRandom){
				...
				//MIENTRAS PARAMETRO DE ITERACIONES CONSTRUCTIVA HACER
					...
					if(sumaSolucion < sumaMejorSolucion){
						fm.escribirArchivo("IteraciÛn GRASP " + j + ": MejorÛ la soluciÛn de "+sumaMejorSolucion+" a "+sumaSolucion, "Ej1.log");
						...
						if(unMatching.isEmpty()){
							System.out.println("SoluciÛn Optima. El Grafo original es Euleriano");
					...
					else
					{
						...
						fm.escribirArchivo("IteraciÛn GRASP " + j + ": No se encontrÛ una mejor soluciÛn en esta iteraciÛn", "Ej1.log");
						System.out.println("IteraciÛn GRASP " + j + ": No se encontrÛ una mejor soluciÛn en esta iteraciÛn");
					}
					++j;
				}
...
//				System.out.println(circuitoEuleriano);
				...
				System.out.println("No existe soluciÛn porque el grafo no es fuertemente conexo");
			}
			grafo = fm.leerInstancia();
			i++;
		}
	}	
	//La b√∫squeda local queda para el de b√∫squeda local
